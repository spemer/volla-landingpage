...
const state = {
  ...
  marketingTerms: '[개인정보 수집/이용] 귀하는 개인(신용)정보의 선택적인 수집∙이용, 제공에 대한 동의를 거부할 수 있습니다. 다만, 동의하지 않을 경우 관련 편의제공 안내 등 이용 목적에 따른 혜택에 제한이 있을 수 있습니다. 동의한 경우에도 귀하는 동의를 철회하거나 마케팅 목적으로 귀하에게 연락하는 것을 중지하도록 요청할 수 있습니다. 당사는 귀하가 본 양식을 제출함으로써, 본 개인정보에 대한 수집 및 이용, 제공 등에 대해 동의를 하는 것으로 간주합니다. 목적: 당사의 상품·서비스 안내 및 이용권유, 이벤트 및 광고성 정보 제공 및 참여기회 제공, 시장조사 및 상품·서비스 개발연구 등',
  ...
  benefits: {
    ...
    bottom: [
      '보다 큰 수익을 위한 낮은 수수료율과, 수수료 할인',
      '보다 활발한 방송을 위한 방송 호스트 지원',
